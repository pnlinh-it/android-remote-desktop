...
public class LicenceStore_Localised extends LicenceStore {
	...
	public byte[] load_licence(String hostName) {
		Preferences prefs = Preferences.userNodeForPackage(this.getClass());
		return prefs.getByteArray("licence." + hostName, null);

	}

	public void save_licence(String hostName,byte[] databytes) {
		Preferences prefs = Preferences.userNodeForPackage(this.getClass());
		prefs.putByteArray("licence." + hostName, databytes);
	}
