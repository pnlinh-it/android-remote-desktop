...
public class VChannels {
	...
	public static final int CHANNEL_OPTION_PRI_HIGH=0x08000000;
	 ...
	 */
	public VChannels(RDPConnection rdpConnection) {
	...
	public void channel_process(RdpPacket_Localised data, int mcsChannel)
			throws RdesktopException, IOException, CryptoException, ConnectionException {
